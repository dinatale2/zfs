...
#	3. Verify safeimport=off and hostids differ (activity check)
...
log_assert "safeimport=on|off inactive pool activity checks"
log_onexit cleanup
...
log_must import_activity_check "-f" $TESTPOOL
...
log_pass "safeimport=on|off inactive pool activity checks passed"
